...
public class ApiISS {
    ...
    public @ResponseBody ResponseEntity<?> getPosition(@RequestParam(required = false) String satellite) throws Exception {
        ...
        String url = satellite == null ? "https://api.n2yo.com/rest/v1/satellite/positions/25544/41.702/-76.014/0/2/&apiKey=6ZV3UP-YQPN6Q-HTXRCL-4YBX" : "https://api.n2yo.com/rest/v1/satellite/positions/" + satellite + "/41.702/-76.014/0/2/&apiKey=6ZV3UP-YQPN6Q-HTXRCL-4YBX";
